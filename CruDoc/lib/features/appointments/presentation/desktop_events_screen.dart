...
class _EventPopupCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasValidPhone = WhatsAppTemplateService.isValidWhatsAppPhone(event.patientPhone);
