...
class LocalDatabaseService extends ChangeNotifier {
  ...
  static const Map<String, String> _medicinesColumns = {
    ...
    'goodStockLevel': 'goodStockLevel INTEGER',
  ...
  static const Map<String, String> _consultationNotesColumns = {
    ...
    'physio': "physio TEXT NOT NULL DEFAULT '{}'",
  ...
  static const Map<String, String> _homeopathyCaseSheetsColumns = {
    ...
    'caseSheetCategory': "caseSheetCategory TEXT NOT NULL DEFAULT 'general'",
    'childhoodHistory': "childhoodHistory TEXT NOT NULL DEFAULT '{}'",
    'childrenCaseSheet': "childrenCaseSheet TEXT NOT NULL DEFAULT '{}'",
    'femaleEndocrine': "femaleEndocrine TEXT NOT NULL DEFAULT '{}'",
    'acuteSheet': "acuteSheet TEXT NOT NULL DEFAULT '{}'",
    'createdAt': 'createdAt INTEGER NOT NULL DEFAULT 0',
    'updatedAt': 'updatedAt INTEGER NOT NULL DEFAULT 0',
    'syncStatus': "syncStatus TEXT NOT NULL DEFAULT 'synced'",
    'pendingDelete': 'pendingDelete INTEGER NOT NULL DEFAULT 0',
  ...
  /// Dental clinical records (perio exams, endo notes, consents, recalls,
  /// pain scores...) as JSON documents by kind.
  Future<void> _createDentalRecordsTable(LocalDatabaseExecutor db) async {
    await db.execute('''
    ...
    ''');
    await db.execute(
      'CREATE INDEX IF NOT EXISTS idx_dental_records_kind '
