  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        // Positioned children at fixed pixel offsets, so a long patient
        // name, a longer condition string, or a larger system font
        // size pushes the rows below it down instead of clipping or
        // painting over them.
        child: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // --- Patient name + status badge + popup menu (header row) ---
            Row(
            ...
            // --- Date & Time — wraps onto a second line on narrow
            // widths instead of overflowing horizontally. ---
            Wrap(
              spacing: 10,
              runSpacing: 4,
            ...
            // --- Big countdown — this is the space a VisitCard spends
            // on a map preview; a clinic appointment has nowhere to
            // navigate to, so it goes to the one thing a home-visit
